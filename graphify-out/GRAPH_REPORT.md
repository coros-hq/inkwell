...
## Corpus Check
- 105 files · ~188,151 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1158 nodes · 2379 edges · 108 communities (66 shown, 42 thin omitted)
...
## Communities (108 total, 42 thin omitted)

### Community 0 - "App Shell & Note Editing"
Cohesion: 0.06
Nodes (50): AttachmentCard(), AttachmentsBarProps, EditorToolbar(), EditorViewContext, EditorViewProvider(), useEditorViewRef(), ViewRef, MarkdownEditor() (+42 more)
...
Cohesion: 0.06
Nodes (45): react, CanvasNotesSheet(), Props, ContentSegment, EMBED_IMAGE_EXTS, EMBED_VIDEO_EXTS, embedFileType(), ExportModeContext (+37 more)
...
Cohesion: 0.08
Nodes (43): genId(), isSelfWrite(), markSelfWrite(), recentWrites, addExternalFileToVault(), deleteFolderDir(), deleteNoteFile(), emptyAppData() (+35 more)

### Community 15 - "Sidebar Drag-and-Drop"
Cohesion: 0.09
Nodes (30): App(), closeThisWindow(), QuickNoteCapture(), ColorRow(), DARK_DEFAULTS, LIGHT_DEFAULTS, normalizeHex(), ThemeEditor() (+22 more)
...
Cohesion: 0.05
Nodes (77): BoardView(), BoardTaskDrawer(), OldTaskDrawer(), PRIORITY_COLORS, PRIORITY_DOT, PRIORITY_TEXT, STATUS_COLORS, STATUS_LABELS (+69 more)
...
Cohesion: 0.20
Nodes (11): ActiveDrag, ColGap(), DropIndicator, COLOR_DOT, KanbanColumn(), KanbanColumnProps, formatDue(), PRIORITY_DOT (+3 more)
...
Cohesion: 0.23
Nodes (17): BoardsState, SyncHandle, AppData, BoardsData, VaultData, AppState, ActiveView, Board (+9 more)
...
Cohesion: 0.07
Nodes (54): JoinVaultDialog(), Props, AbbreviationsSection(), CustomThemeCard(), FONT_OPTIONS, FONT_SIZE_OPTIONS, formatVaultDate(), LINE_HEIGHT_OPTIONS (+46 more)
...
- **Why does `useAppStore` connect `Weekly Planner View` to `App Shell & Note Editing`, `Editor Toolbar & Attachments`, `Canvas Shape Type Definitions`, `Canvas Geometry & Rendering`, `GitHub Sync Settings UI`, `ShellScopeEntryAllowedArg`, `CodeMirror Editor Decorations`, `Note List & Deletion`, `Date Picker Component`?**
