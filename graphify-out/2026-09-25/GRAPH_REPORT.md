...
Cohesion: 0.17
Nodes (13): AttachmentCard(), AttachmentsBar(), AttachmentsBarProps, MediaItem(), MediaPanel(), MediaPanelProps, deleteAttachmentFile(), detectType() (+5 more)
...
Cohesion: 0.07
Nodes (40): react, CanvasNotesSheet(), ContentSegment, EMBED_IMAGE_EXTS, EMBED_VIDEO_EXTS, embedFileType(), ExportModeContext, extractText() (+32 more)

### Community 3 - "NPM Dependencies (runtime)"
Cohesion: 0.04
Nodes (53): dependencies, class-variance-authority, clsx, codemirror, @codemirror/autocomplete, @codemirror/commands, @codemirror/lang-markdown, @codemirror/language (+45 more)
...
Cohesion: 0.13
Nodes (27): KanbanColumnProps, LinksPanel(), LinksPanelProps, AttachmentChip(), AttachmentChipProps, NoteEntry, patchYMapFromArray(), Peer (+19 more)
...
Cohesion: 0.08
Nodes (21): ChartInsertDialog(), defaultState(), stateFromSpec(), TYPE_OPTIONS, barPath(), CartesianChart(), ChartDataset, ChartSpec (+13 more)
...
Cohesion: 0.11
Nodes (31): genId(), ephemeralNoteIds, externalNoteId(), extractTitle(), fileSearchCache, findExternalSearchRoot(), findFileInVault(), findFolderRelPath() (+23 more)

### Community 15 - "Sidebar Drag-and-Drop"
Cohesion: 0.29
Nodes (7): NoteList(), NoteRow(), confirmDeleteNote(), confirmDeleteNotes(), handleNoteSelect(), SelectNoteOptions, glassBg()
...
Cohesion: 0.07
Nodes (29): activeLineSet(), buildChartDecorations(), buildFileEmbedDecorations(), buildLiveMarkdownDecorations(), buildMathDecorations(), buildTableDecorations(), buildTablePreviewDecorations(), BUILT_IN_ABBREVIATIONS (+21 more)
...
Cohesion: 0.16
Nodes (16): DragItemData, DropIndicator, DropPosition, findFolderChildren(), findNotesInFolder(), flatFolders(), folderIconOffset(), folderPadding() (+8 more)
...
Cohesion: 0.13
Nodes (16): EditorViewContext, EditorViewProvider(), useEditorViewRef(), ViewRef, NoteSearchBar(), NoteSearchBarProps, HeadingTick, parseHeadings() (+8 more)
...
Cohesion: 0.32
Nodes (6): formatDue(), PRIORITY_DOT, TaskCard(), TaskCardProps, TagChip(), TagChipProps

### Community 38 - "GitHubSyncDialog.tsx"
Cohesion: 0.15
Nodes (14): BoardTaskDrawer(), OldTaskDrawer(), PRIORITY_COLORS, PRIORITY_DOT, PRIORITY_TEXT, STATUS_COLORS, STATUS_LABELS, TaskDrawer() (+6 more)
...
Cohesion: 0.24
Nodes (4): embedFormatSize(), FileEmbedWidget, TableRow, uint8ToBase64()

### Community 42 - "BoardView.tsx"
Cohesion: 0.08
Nodes (11): getVaultSession(), VaultRole, persistCustomThemes(), checkForAppUpdate(), ConfirmConfig, findFolderPath(), flushBoards(), isFolderInsideDeleted() (+3 more)
...
Cohesion: 0.14
Nodes (13): MarkdownEditor(), MarkdownEditorProps, SplitViewProps, chartPreviewField, codeHighlighting, createFileEmbedPlugin(), liveMarkdownPlugin, mathPreviewField (+5 more)
...
Cohesion: 0.29
Nodes (3): escapeHtml(), renderInlineCell(), TableWidget
...
### Community 110 - "local"
Cohesion: 0.27
Nodes (13): EditorToolbar(), MarkdownField(), MarkdownFieldProps, makeAttachmentMarkdown(), pickAndCopyAttachment(), applyBlockFormat(), applyFormatAction(), applyInlineFormat() (+5 more)
...
Cohesion: 0.05
Nodes (57): isSelfWrite(), markSelfWrite(), recentWrites, attachmentExistsLocally(), downloadAttachment(), objectPath(), uploadAttachment(), base64ToBytes() (+49 more)
...
- **Why does `useAppStore` connect `useAppStore` to `App Shell & Note Editing`, `Editor Toolbar & Attachments`, `Canvas Geometry & Rendering`, `GitHub Sync Settings UI`, `Board Drag & Attachments UI`, `Sidebar Drag-and-Drop`, `CodeMirror Editor Decorations`, `Weekly Planner View`, `Date Picker Component`, `Canvas Shape Type Definitions`, `GitHubSyncDialog.tsx`, `BoardView.tsx`, `attachments.ts`, `JoinVaultDialog.tsx`, `CanvasNotesSheet.tsx`, `Desktop Shell Scope Args`, `gitSync.ts`, `ShellScopeEntryAllowedArg`, `ShellScopeEntryAllowedArg`, `local`, `ShellScopeEntryAllowedArgs`, `auth.ts`, `vaultWatcher.ts`, `CanvasNotesSheet.tsx`?**
