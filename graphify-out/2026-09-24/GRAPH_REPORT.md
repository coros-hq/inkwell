...
Cohesion: 0.19
Nodes (13): AttachmentCard(), AttachmentsBarProps, MediaItem(), MediaPanel(), MediaPanelProps, deleteAttachmentFile(), detectType(), fileIcon() (+5 more)
...
Cohesion: 0.07
Nodes (42): react, CanvasNotesSheet(), Props, ContentSegment, EMBED_IMAGE_EXTS, EMBED_VIDEO_EXTS, embedFileType(), ExportModeContext (+34 more)
...
Cohesion: 0.17
Nodes (24): KanbanColumnProps, NoteRowProps, AttachmentChip(), AttachmentChipProps, BoardsState, SyncHandle, formatFileSize(), AppData (+16 more)
...
Cohesion: 0.10
Nodes (40): genId(), markSelfWrite(), addExternalFileToVault(), deleteFolderDir(), deleteNoteFile(), emptyAppData(), externalNoteId(), extractTitle() (+32 more)

### Community 15 - "Sidebar Drag-and-Drop"
Cohesion: 0.35
Nodes (9): EditorPane(), NoteList(), TagChip(), TagChipProps, confirmDeleteNote(), confirmDeleteNotes(), confirmDeleteSelectedNotes(), formatDate() (+1 more)
...
Cohesion: 0.12
Nodes (18): DragItemData, DropIndicator, DropPosition, findFolderChildren(), findNotesInFolder(), flatFolders(), folderIconOffset(), folderPadding() (+10 more)
...
Cohesion: 0.19
Nodes (16): EditorToolbar(), EditorViewContext, EditorViewProvider(), useEditorViewRef(), ViewRef, MarkdownEditor(), NoteSearchBar(), NoteSearchBarProps (+8 more)
...
Cohesion: 0.09
Nodes (6): checkForAppUpdate(), Abbreviation, ConfirmConfig, findFolderPath(), isFolderInsideDeleted(), NamePromptConfig
...
Cohesion: 0.17
Nodes (10): AttachmentsBar(), ConflictBanner(), DropLine(), CustomThemeCard(), ThemeCard(), ToggleSwitch(), ConfirmDialog(), cn() (+2 more)

### Community 48 - "JoinVaultDialog.tsx"
Cohesion: 0.21
Nodes (16): App(), AppShell(), closeThisWindow(), QuickNoteCapture(), SearchOverlay(), comboMatches(), isDarkTheme(), loadCustomThemes() (+8 more)
...
Cohesion: 0.10
Nodes (16): MarkdownEditorProps, chartPreviewField, codeHighlighting, liveMarkdownPlugin, mathPreviewField, slashCommandCompletion, tablePreviewField, tryAbbreviationReplace() (+8 more)
...
Cohesion: 0.36
Nodes (7): ChartInsertDialog(), defaultState(), stateFromSpec(), TYPE_OPTIONS, ChartType, normalizeWrappedStrings(), parseSpec()
...
Cohesion: 0.05
Nodes (74): JoinVaultDialog(), Props, FONT_OPTIONS, FONT_SIZE_OPTIONS, formatVaultDate(), LINE_HEIGHT_OPTIONS, NAV_ITEMS, Section (+66 more)
...
Cohesion: 0.33
Nodes (5): CustomTheme, DARK_THEMES, LIGHT_THEMES, persistCustomThemes(), ThemeDef

### Community 115 - "vaultWatcher.ts"
Cohesion: 0.33
Nodes (5): isSelfWrite(), recentWrites, FsWatchEvent, NOOP_HANDLE, VaultWatcherHandle
...
- **Why does `useAppStore` connect `GitHubSyncDialog.tsx` to `App Shell & Note Editing`, `Editor Toolbar & Attachments`, `Canvas Shape Type Definitions`, `Canvas Geometry & Rendering`, `ShellScopeEntryAllowedArg`, `BoardView.tsx`, `attachments.ts`, `JoinVaultDialog.tsx`, `Sidebar Drag-and-Drop`, `ShellScopeEntryAllowedArgs`, `CanvasNotesSheet.tsx`, `CodeMirror Editor Decorations`, `Weekly Planner View`, `gitSync.ts`, `Note List & Deletion`, `Date Picker Component`?**
